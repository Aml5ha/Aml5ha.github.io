  ...
  <section id="about">
    <div className="row">
      ...
      <div className="nine columns main-col">
        <h2>About Me</h2>
        <p>
          As mentioned before, I am <span>Arman Lokhandwala</span>, and I'm currently working at <span>Capital One</span> in McLean, VA.
          ...
          My passions include technology, cars, games, science and astronomy, psychology, teaching, and most importantly, empowering others. 

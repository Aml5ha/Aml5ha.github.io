    ...
    <div className="nine columns main-col">
      ...
      <div className="row item">
        <div className="twelve columns">
          <h3>CarMax</h3> 
          <p className="info">
            Summer IT intern for CarMax Order Processing
            <span>&bull;</span>
            <em className="date">June 2018 - August 2018</em>
          </p>
          <p>
            This internship experience helped introduced me to back-end development with my placement being on a small product team of 6 developers. Some notable accomplishments were:
            <br/>
            - Created a new customer API from its defining stages to its release.
            <br/>
            - Organized a workshop to senior members on my team about the importance of personal brand and online presence on LinkedIn.
            <br/>
            - Introduced a formal code review process to the team allowing them to produce quality products more efficiently. 
            <br/>          
       ...
       <div className="row item">
        <div className="twelve columns">
          <h3>CarMax </h3>
          <p className="info">
            Summer IT intern for CarMax Merchandising 
            <span>&bull;</span>
            <em className="date">June 2017 - August 2017</em>
          </p>
          <p>
            This experience helped introduce me to front-end development as well as cloud computing while exposing me to the full development lifecycle; I was able to see web development from its architectural defining stages all the way through its production release. Some notable accomplishments were:
            <br/>
            - Created and implement a new content management system using Microsoft Azure. 
            <br/>
            - Practiced agile methodology on a team of 10 and was exposed to normal scrum procedures. 
            <br/>
            - Proposed, developed, and released a new front end experience for 1/3 of the business to use.
            <br/>
            Skills I learned from this experience include but are not limited to: 
            <ul>  
      ...
      <div className="row item">
        <div className="twelve columns">
          <h3>University of Virginia: Office of the Dean of Students</h3>
          <p className="info">
      ...
      <div className="row item">
        <div className="twelve columns">
          <h3>University of Virginia: Department of Electrical and Computer Engineering</h3>
          <p className="info">
      ...
      <div className="row item">
        <div className="twelve columns">
          <h3>YMCA of Greater Richmond</h3>
          <p className="info">
